...
// if(isset($_POST['name'])) {
  ...
  //   $pass = $_POST['password'];
  //   $city = $_POST['city'];
  //   $sql = "INSERT INTO `event_ticket_booking_website_db`.`users` (`User_Name`, `User_Email`, `User_Phone`, `User_Password`, `User_City_Preference`) VALUES ('$name', '$email', '$phone', '$pass', '$city');";
  //   echo $sql;
  ...
  //   if($con->query($sql) == true){ $insert = true; } $con->close(); 
  // }
?>
...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  {   
    ...
    $pass = $_POST['password'];
    $city = $_POST['city'];
    $sql = "INSERT INTO `event_ticket_booking_website_db`.`users` (`User_Name`, `User_Email`, `User_Phone`, `User_Password`, `User_City_Preference`) VALUES (?, ?, ?, ?, ?);";
      // $sql = "INSERT INTO users (username, password) VALUES (?, ?)";
      $stmt = mysqli_prepare($conn, $sql);
      if ($stmt)
      {
          mysqli_stmt_bind_param($stmt, "ssiss", $param_name, $param_email, $param_phone, $param_password, $param_city);
